...
Public Property Let sectionname(section As String, Name As String)
    ...
    End If
End Property
Public Function isroot(text As String) As Boolean
...
End Function
Public Function isnotroot(value As String) As Boolean
...
End If
End Sub
Public Sub saveoldroot(filenumber As Long)
If entrycount = 0 Then Exit Sub
...
Public Sub saveoldsection(section As String, filenumber As Long)
If entrycount = 0 Then Exit Sub
...
Public Sub closefile()
    ...
    isloaded = False
End Sub
Public Function findroot(start As Long) As Long
If entrycount = 0 Then Exit Function
...
End If
End Function
Public Function countkeys(start As Long) As Long
If entrycount = 0 Then Exit Function
...
countkeys = keys
End Function
Public Function counthandlekeys(start As Long, index As Long) As Long
If entrycount = 0 Then Exit Function
    Dim count As Long, keys As Long
For count = start To findroot(start)
    If inifile(count).level = inifile(start).level + 1 Then
...
Next
End Function
Public Function countinstancekeys(start As Long, key As String) As Long
If entrycount = 0 Then Exit Function
...
End Function
Public Function getkeysinstance(start As Long, handle As Long) As Long
If entrycount = 0 Then Exit Function
...
End Function
Public Function countsections(start As Long) As Long
If entrycount = 0 Then Exit Function
...
Public Sub enumsections(start As Long, STRarray)
If entrycount = 0 Then Exit Sub
    Dim count As Long, sections As Long
For count = start To findroot(start)
    If inifile(count).level = inifile(start).level + 1 Then
...
countrootkeys = keys
End Function
Public Sub enumkeys(start As Long, STRarray)
If entrycount = 0 Then Exit Sub
    Dim count As Long, keys As Long
If start > 0 Then
For count = start To findroot(start)
...
End If
End Sub
Public Function sectionexists(start As Long, section As String) As Boolean
If entrycount = 0 Then Exit Function
        Dim tempstr() As String, count As Long, temp As Long
    If start > 0 Then
...
If entrycount = 0 Then Exit Function
    ...
    End If
End Function
Public Function sectionindex(start As Long, index As Long) As String
If entrycount = 0 Then Exit Function
...
End Function
Public Function keyexists(start As Long, key As String, Optional index As Long = 0) As Boolean
    If entrycount = 0 Then Exit Function
...
If entrycount = 0 Then Exit Function
    ...
    End If
End Function
Public Function keyhandle(start As Long, key As String, Optional index As Long = 0) As Long
If entrycount = 0 Then Exit Function
...
End Function
Public Function countmultikey(start As Long, key As String) As Long
If entrycount = 0 Then Exit Function
    On Error Resume Next
...
End Function
Public Function getkey(start As Long, key As String, Optional index As Long = 0) As String
If entrycount = 0 Then Exit Function
...
End Function
Public Sub setkey(start As Long, key As String, value As String, Optional index As Long = 0)
Dim count As Long, count2 As Long, found As Boolean
found = False
...
End If
End Sub
Public Function sectionhandle(start As Long, section As String) As Long
If entrycount = 0 Then Exit Function
    Dim count As Long
If start > 0 Then
For count = start To findroot(start)
...
End If
End Function
Public Sub renamekey(start As Long, key As String, Name As String, Optional index As Long = 0, Optional newindex As Long = 0)
If entrycount = 0 Then Exit Sub
    Dim temp As Long
...
If entrycount = 0 Then Exit Sub
    ...
    End If
End Sub
Public Sub removesection(start As Long)
If entrycount = 0 Then Exit Sub
        removerange start, findroot(start)
End Sub
Public Sub renamesection(start As Long, section As String)
If entrycount = 0 Then Exit Sub
...
Next
End Sub
Public Sub createsection(ByVal start As Long, section As String)
    Dim finish As Long
    ...
    End If
End Sub
Public Sub insert(start As Long, level As Long, contents As String)
Dim count As Long
entrycount = entrycount + 1
ReDim Preserve inifile(1 To entrycount)
...
End Sub
Public Sub removerange(top As Long, bottom As Long)
If entrycount = 0 Then Exit Sub
...
If entrycount = 0 Then Exit Sub
     ...
     Next
End Sub
Public Sub removedoublekey(start As Long)
If entrycount = 0 Then Exit Sub
    ...
    Next
End Sub
Public Sub removedoublessection(start As Long)
If entrycount = 0 Then Exit Sub
        Dim count As Long, count2 As Long, count3 As Long
    Dim root As Long
    root = findroot(start) - 1
